...
You can start using Asana directly from [agentr.dev](https://agentr.dev). Visit [agentr.dev/apps](https://agentr.dev/apps) and enable Asana.
...
The full list of available tools is at [./src/universal_mcp_asana/README.md](./src/universal_mcp_asana/README.md)
...
4. **Install the Application**
   ```bash
   mcp install src/universal_mcp_asana/mcp.py
   ```
